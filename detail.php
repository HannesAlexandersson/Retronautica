<div class="detail-header">
  <div class="header-container default-font">
    <h1 class="header-text">
      Jubileumsvisningar av Stanley Kubricks mästerverk
    </h1>
...
<div class="redeye-textWrapper secondary-font white-text heavy-weight">
  <span class="secondary-font white-text">
    ...
    <p class="redeye-p">
      ...
      med sin visuella storslagenhet och djupa filosofiska resonemang. Få en chans att uppleva 
      varför det fortfarande är en av de mest älskade filmerna genom tiderna! Bio Retronautica 
      kommer att omvandlas till en portal till det okända under våra speciella jubileumsvisningar. 
      Upplev filmen som aldrig förr med förbättrat ljud, skarpare bild och en atmosfär som tar dig 
      med på en resa genom tid och rum. Det här är inte bara en visning, det är en fest för dina 
  ...
  <div class="redeye-textWrapper secondary-font white-text heavy-weight">
    ...
    <p class="redeye-p">
      ...
      2001: A Space Odyssey och låt oss tillsammans skapa minnen som sträcker sig över galaxerna! 
      Kom och förlora dig själv i rymdens oändliga mysterier - vi ses på <strong>Bio Retronautica!</strong>
    </p>
  </div>
</div>